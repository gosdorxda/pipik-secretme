...
function MessageCard({
  ...
  const { stripe, bg, border } = MESSAGE_PALETTE[idx % MESSAGE_PALETTE.length];
      ...
      <div className="px-4 pb-3 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1 min-w-0">
              ...
              <button
                ...
                className={[
                  ...
                  reacted === emoji
                    ...
                    : "bg-black/5 dark:bg-white/10 opacity-60 hover:opacity-90 hover:bg-black/10 dark:hover:bg-white/15",
                ].join(" ")}
              >
          ...
          <div className="relative" ref={pickerRef}>
            ...
            {/* Tooltip picker */}
            {pickerOpen && (
              <div className="absolute bottom-full left-0 mb-2 bg-white dark:bg-card border border-border/50 rounded-2xl shadow-xl px-1.5 py-1 flex items-center gap-0.5 z-20 whitespace-nowrap">
                {/* Panah kecil */}
                <span className="absolute -bottom-1.5 left-3 w-3 h-3 bg-white dark:bg-card border-b border-r border-border/50 rotate-45" />
        ...
        <button
          onClick={onShare}
          className="inline-flex items-center gap-1.5 text-[11px] font-semibold text-muted-foreground hover:text-foreground transition-colors px-2.5 py-1 rounded-md border border-border/60 hover:border-border bg-white/60 dark:bg-white/10 hover:bg-white dark:hover:bg-white/20 shrink-0"
        >
      ...
      {active.map((item) => {
        ...
        return (
          <a
            ...
            className="w-9 h-9 rounded-md bg-white dark:bg-card border border-border hover:border-border/60 flex items-center justify-center transition-all duration-150 hover:shadow-sm"
          >
            {item.icon}
          </a>
        );
    ...
    return (
      <div className="min-h-[100dvh] bg-background text-foreground flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4">
          <div className="border border-border bg-white dark:bg-card p-12 shadow-sm text-center max-w-sm w-full rounded-md">
  ...
  return (
    <div className="min-h-[100dvh] bg-background text-foreground flex flex-col">
      ...
      <div className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 w-full space-y-6">
        ...
        <div className="flex flex-col items-center gap-4 py-6 text-center">
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-muted-foreground hover:text-foreground transition-colors px-3 py-1.5 rounded-md border border-border hover:border-border/60 bg-white dark:bg-card/60 hover:bg-accent/30"
            >
              {shareCopied ? (
                <>
        ...
        <div
          id="send-form"
          className="bg-white dark:bg-card border border-border rounded-md overflow-hidden"
        >
      ...
      {!isSignedIn && !bubbleDismissed && (
        <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50 px-4 w-full max-w-sm pointer-events-none">
          <div className="cta-shake pointer-events-auto flex items-center gap-3 bg-white dark:bg-card border border-border rounded-full shadow-xl px-4 py-2.5 animate-in slide-in-from-bottom-4 duration-300">
            {/* Logo */}
