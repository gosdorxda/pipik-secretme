        ...
        <div className="max-w-4xl mx-auto px-5 py-14 space-y-10">
          {faqItems.map(({ category, items }) => (
            <div key={category}>
              ...
              <div className="rounded-md border border-border bg-white dark:bg-card overflow-hidden divide-y divide-border">
        ...
        <div className="max-w-4xl mx-auto px-5 py-12 text-center">
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            {contactEmail && (
              <a
                href={`mailto:${contactEmail}`}
                className="inline-flex items-center gap-2 border border-border bg-white dark:bg-card text-foreground px-5 py-2.5 rounded-md text-sm font-medium hover:bg-secondary/50 transition-colors"
              >
                Hubungi Kami
              </a>
            )}
